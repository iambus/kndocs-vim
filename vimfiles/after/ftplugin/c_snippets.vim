...
" Kneo
exec "Snippet cm <cr>#include <stdio.h><cr><cr>int main ()<cr>{<cr>".st.et.";<cr>return 0;<cr>}<cr>"
exec "Snippet u <cr>#include <iostream><cr><cr>using namespace std;<cr><cr>int main ()<cr>{<cr>".st.et.";<cr>return 0;<cr>}<cr>"
