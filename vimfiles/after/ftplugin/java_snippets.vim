...
exec "Snippet c public final class ".st."``expand('%:t:r')``".et." {<CR>".st.et."<CR>}"
exec "Snippet con public ``expand('%:t:r')``(".st.et.") {<CR>".st.et."<CR>}"
exec "Snippet main public static void main(String[] args) {<CR>".st.et."<CR>}<CR>"
exec "Snippet cm public final class ".st."``expand('%:t:r')``".et." {<CR>public static void main(String[] args) {<CR>".st.et."<CR>}<CR>}"
exec "Snippet ct import org.junit.Test;<CR>import static org.junit.Assert.*;<CR><CR>public final class ".st."``expand('%:t:r')``".et." {<CR>".st.et."<CR>}"
